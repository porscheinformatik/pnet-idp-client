...
public class Saml2Utils {
    ...
    static final Pattern AUTO_GENERATED_RELAY_STATE_PATTERN = Pattern.compile(
        String.format(AUTO_GENERATED_RELAY_STATE_FORMAT, ".{36}", "(.*)")
    );
    ...
    public static UriComponentsBuilder maxSessionAge(
    ...
    public static UriComponentsBuilder maxAgeMfa(UriComponentsBuilder uriComponentsBuilder, Integer maxAgeInSeconds) {
    ...
    public static UriComponentsBuilder requestNistAuthenticationLevel(
        ...
        if (supportedValues.isEmpty()) {
            int maxValue = supportedValues
                .stream()
                .map(AuthnContextClass::getNistLevel)
                .max(Integer::compare)
                .orElse(0);
