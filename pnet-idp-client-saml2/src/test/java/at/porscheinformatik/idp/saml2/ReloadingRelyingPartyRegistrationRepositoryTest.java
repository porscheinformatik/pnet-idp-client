...
class ReloadingRelyingPartyRegistrationRepositoryTest {
    ...
    void testFindByCorrectRegistrationId() throws Exception {
        ...
        assertThat(
            idpDetails.getSingleSignOnServiceLocation(),
        ...
        assertThat(
            vCDescription,
            firstCertificateAsString(verificationCredentials),
    ...
    private ReloadingRelyingPartyRegistrationRepository buildRepository(
        String entityId,
        String metadataUrl,
        String metadataFile
    ) throws Exception {
        Saml2CredentialsManager credentialsManager = Saml2TestUtils.defaultCredentialsManager();
        return new ReloadingRelyingPartyRegistrationRepository(
            "rpId",
            entityId,
            metadataUrl,
            credentialsManager,
            new TestClientFactory(metadataFile, metadataUrl),
            "/saml2/sso/post/{registrationId}",
