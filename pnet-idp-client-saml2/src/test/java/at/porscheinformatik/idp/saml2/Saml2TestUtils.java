...
public class Saml2TestUtils
{
    public static List<Saml2CredentialsConfig> defaultCredentials()
    {
        return Arrays
            .asList(
                signingKey("classpath:at/porscheinformatik/idp/saml2/keys.keystore", "PKCS12", "somepass", "myprivate",
                    "mypublic"),
                decryptionKey("classpath:at/porscheinformatik/idp/saml2/keys.keystore", "PKCS12", "somepass",
                    "myprivate", "mypublic"));
    }
