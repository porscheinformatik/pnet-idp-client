...
public class DecidingAuthenticationEntryPoint implements AuthenticationEntryPoint
{
    ...
    private UriComponentsBuilder buildSaml2Path(boolean requireMfa, Integer maxAge, boolean forceAuthentication, Integer maxAgeMfa, String tenant)
    {
    ...
    private UriComponentsBuilder buildOidcPath(boolean requireMfa, Integer maxAge, boolean forceAuthentication, Integer maxAgeMfa, String tenant)
    {
